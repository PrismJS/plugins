...
import { resolveAlias } from 'prismjs/src/shared/meta/alias-data';
import { toArray } from 'prismjs/src/shared/util';
import type { Prism } from 'prismjs/src/core';
import type { ComponentProto, PluginProto } from 'prismjs/src/types';
