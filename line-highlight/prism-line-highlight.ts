import { isActive } from 'prismjs/src/shared/dom-util';
import { combineCallbacks } from 'prismjs/src/shared/hooks-util';
import { lazy, noop } from 'prismjs/src/shared/util';
